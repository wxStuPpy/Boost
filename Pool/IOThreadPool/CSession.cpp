...
void CSession::Start()
{
  ...
  _socket.async_read_some(
      ...
      boost::asio::bind_executor(_strand, std::bind(&CSession::handleRead, this, _1, _2, shared_from_this())));
}
  ...
  if (!error)
  {
    ...
    if (!_sendQueue.empty())
    {
      ...
      boost::asio::async_write(
          ...
          boost::asio::bind_executor(_strand, std::bind(&CSession::handleWrite, this, _1, selfShared)));
    }
  }
  else
  {
...
void CSession::send(std::string msg, short msgID)
{
  ...
  boost::asio::async_write(
      _socket, boost::asio::buffer(msgnode->_data, msgnode->_totalLen),
      boost::asio::bind_executor(_strand, std::bind(&CSession::handleWrite, this, _1, shared_from_this())));
}
